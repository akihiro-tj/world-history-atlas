...
export function DetailPanel({ feature, onClose }: DetailPanelProps) {
  return (
    <section
      ...
      className="absolute z-10 bg-white shadow-lg max-md:inset-x-0 max-md:bottom-0 max-md:rounded-t-xl max-md:p-4 md:top-0 md:right-0 md:h-full md:w-80 md:overflow-y-auto md:p-6 dark:bg-slate-800"
    >
      ...
      <p className="mt-1 flex gap-2 text-sm text-slate-500 dark:text-slate-400">
